...
class Docs extends Api_Controller
{
	...
	public function catalog()
	{
		...
		$endpoints = array(
			...
			array('group' => 'Inventory', 'method' => 'PUT', 'path' => '/inventory/{id}', 'auth' => true, 'roles' => array('promoter_admin', 'marketing_team_admin'), 'summary' => 'Update unit / status / price (team admin: assigned projects only)', 'input' => array('status' => 'on_hold', 'price' => 3700000), 'output' => array('success' => true)),
			...
			array('group' => 'Inventory', 'method' => 'POST', 'path' => '/inventory/bulk', 'auth' => true, 'roles' => array('promoter_admin', 'marketing_team_admin'), 'summary' => 'Bulk status update (team admin: assigned projects only)', 'input' => array('ids' => array(1, 2), 'action' => 'change_status', 'status' => 'on_hold', 'remarks' => 'Hold batch'), 'output' => array('updated' => 2)),
