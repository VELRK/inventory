...
class Docs extends Api_Controller
{
	...
	public function catalog()
	{
		...
		$endpoints = array(
			...
			array('group' => 'Bookings', 'method' => 'POST', 'path' => '/bookings', 'auth' => true, 'roles' => array('promoter_admin', 'marketing_team_admin'), 'summary' => 'Insert bookings row + set unit booked. Unit must be available or on_hold. Requires bookings.manage', 'input' => array('unit_id' => 1, 'customer_name' => 'Ravi Kumar', 'customer_phone' => '9843000000', 'amount' => 3600000, 'booking_date' => '2026-08-24', 'company_id' => 1, 'status' => 'confirmed', 'payment_status' => 'partial', 'notes' => ''), 'output' => array('id' => 3, 'unit_id' => 1, 'status' => 'confirmed')),
