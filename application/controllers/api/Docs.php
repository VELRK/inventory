...
class Docs extends Api_Controller
{
	...
	public function catalog()
	{
		...
		$endpoints = array(
			...
			array('group' => 'Inventory', 'method' => 'PUT', 'path' => '/inventory/{id}', 'auth' => true, 'roles' => array('promoter_admin', 'marketing_team_admin'), 'summary' => 'Update unit / price / available|on_hold only. Setting status to booked/registered returns USE_BOOKING_FLOW — use POST /bookings or POST /registrations', 'input' => array('status' => 'on_hold', 'price' => 3700000), 'output' => array('success' => true)),
