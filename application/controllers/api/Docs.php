	...
	public function catalog()
	{
		...
		$endpoints = array(
			array(
				...
				'input' => array('email' => 'velrke@gmail.com', 'password' => 'Admin@123'),
			...
			array('group' => 'Auth', 'method' => 'GET', 'path' => '/auth/me', 'auth' => true, 'summary' => 'Current user profile', 'input' => new stdClass(), 'output' => array('success' => true, 'data' => array('email' => 'velrke@gmail.com'))),
			array('group' => 'Auth', 'method' => 'POST', 'path' => '/auth/forgot', 'auth' => false, 'summary' => 'Email password reset link (all roles: admin, team admin, team user)', 'input' => array('email' => 'velrke@gmail.com'), 'output' => array('success' => true)),
			...
			array('group' => 'Dashboard', 'method' => 'GET', 'path' => '/dashboard', 'auth' => true, 'summary' => 'KPI cards. inventory.booked = active bookings rows; inventory.registered = active registrations rows (not orphan unit status)', 'input' => new stdClass(), 'output' => array('total_projects' => 3, 'inventory' => array('available' => 6, 'booked' => 0, 'registered' => 0))),
			array('group' => 'Dashboard', 'method' => 'GET', 'path' => '/dashboard/charts', 'auth' => true, 'summary' => 'Charts: booked/registered from bookings & registrations tables; monthly excludes cancelled', 'input' => new stdClass(), 'output' => array('status_pie' => array())),
			...
			array('group' => 'Projects', 'method' => 'GET', 'path' => '/projects/{id}', 'auth' => true, 'summary' => 'Project detail; counts.booked/registered from bookings & registrations tables', 'input' => new stdClass(), 'output' => array('name' => 'Royal City', 'counts' => array('available' => 0, 'booked' => 0, 'registered' => 0))),
			array('group' => 'Projects', 'method' => 'PUT', 'path' => '/projects/{id}', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Update project. Prefer multipart/form-data with file field cover_image (or file). Do not send base64 into cover_image string.', 'input' => array('name' => 'Grand Town', 'city' => 'Coimbatore', 'cover_image' => '(multipart image file)'), 'output' => array('success' => true)),
			...
			array('group' => 'Inventory', 'method' => 'GET', 'path' => '/inventory', 'auth' => true, 'summary' => 'Units list. Query: project_id, status, q, page. stats.booked/registered from bookings & registrations tables', 'input' => array('status' => 'available'), 'output' => array('items' => array(), 'stats' => array())),
			array('group' => 'Inventory', 'method' => 'POST', 'path' => '/inventory', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Create unit (status forced to available if booked/registered sent)', 'input' => array('project_id' => 1, 'unit_no' => 'A-110', 'area_sqft' => 1200, 'price' => 3600000, 'facing' => 'East'), 'output' => array('id' => 13)),
			...
			array('group' => 'Inventory', 'method' => 'PUT', 'path' => '/inventory/{id}', 'auth' => true, 'roles' => array('promoter_admin', 'marketing_team_admin'), 'summary' => 'Update unit. Status available|on_hold|booked|registered. Changing to booked/registered requires customer_name and inserts bookings/registrations row', 'input' => array('status' => 'booked', 'customer_name' => 'Ravi Kumar', 'customer_phone' => '9843000000', 'price' => 3700000), 'output' => array('success' => true)),
			...
			array('group' => 'Inventory', 'method' => 'GET', 'path' => '/inventory/stats', 'auth' => true, 'summary' => 'Per-project breakdown; booked/registered count table rows', 'input' => new stdClass(), 'output' => array('stats' => array(), 'projects' => array())),
			array('group' => 'Inventory', 'method' => 'POST', 'path' => '/inventory/bulk', 'auth' => true, 'roles' => array('promoter_admin', 'marketing_team_admin'), 'summary' => 'Bulk status: available or on_hold only (booked/registered blocked)', 'input' => array('ids' => array(1, 2), 'action' => 'change_status', 'status' => 'on_hold', 'remarks' => 'Hold batch'), 'output' => array('updated' => 2)),
			...
			array('group' => 'Users', 'method' => 'POST', 'path' => '/users', 'auth' => true, 'summary' => 'Create user (no password). Emails a set-password link. Team admin can only create team users in own company.', 'input' => array('name' => 'Sales Exec', 'email' => 'exec@abc.test', 'role' => 'marketing_team_user', 'company_id' => 1, 'project_ids' => array(1)), 'output' => array('id' => 5)),
			...
			array('group' => 'Bookings', 'method' => 'POST', 'path' => '/bookings', 'auth' => true, 'roles' => array('promoter_admin', 'marketing_team_admin'), 'summary' => 'Insert bookings row + set unit booked. unit_id may be numeric id OR unit_no (e.g. F282); if unit_no is shared across projects pass project_id', 'input' => array('unit_id' => 'F282', 'project_id' => 1, 'customer_name' => 'Ravi Kumar', 'customer_phone' => '9843000000', 'amount' => 3600000, 'booking_date' => '2026-08-24', 'company_id' => 1, 'status' => 'confirmed', 'payment_status' => 'partial', 'notes' => ''), 'output' => array('id' => 3, 'unit_id' => 1, 'status' => 'confirmed')),
			array('group' => 'Bookings', 'method' => 'PUT', 'path' => '/bookings/{id}', 'auth' => true, 'roles' => array('promoter_admin', 'marketing_team_admin'), 'summary' => 'Update booking; cancelling releases unit to available', 'input' => array('status' => 'confirmed', 'payment_status' => 'paid'), 'output' => array('success' => true)),
			array('group' => 'Bookings', 'method' => 'DELETE', 'path' => '/bookings/{id}', 'auth' => true, 'roles' => array('promoter_admin', 'marketing_team_admin'), 'summary' => 'Soft-delete booking and release unit if still booked', 'input' => new stdClass(), 'output' => array('success' => true)),
			...
			array('group' => 'Registrations', 'method' => 'GET', 'path' => '/registrations', 'auth' => true, 'summary' => 'Registrations list (rows from registrations table)', 'input' => new stdClass(), 'output' => array('items' => array())),
			array('group' => 'Registrations', 'method' => 'POST', 'path' => '/registrations', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Insert registrations row + set unit registered. Unit must already be booked. Requires registrations.manage', 'input' => array('unit_id' => 4, 'customer_name' => 'Suresh Nair', 'customer_phone' => '9843000001', 'amount' => 2800000, 'registration_date' => '2026-08-24', 'company_id' => 1, 'booking_id' => 3), 'output' => array('id' => 2, 'unit_id' => 4, 'status' => 'confirmed')),
			array('group' => 'Registrations', 'method' => 'PUT', 'path' => '/registrations/{id}', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Update registration; cancelling restores unit to booked or available', 'input' => array('status' => 'confirmed', 'payment_status' => 'paid'), 'output' => array('success' => true)),
			array('group' => 'Registrations', 'method' => 'DELETE', 'path' => '/registrations/{id}', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Soft-delete registration; unit returns to booked if booking exists else available', 'input' => new stdClass(), 'output' => array('success' => true)),
			...
			array('group' => 'Settings', 'method' => 'GET', 'path' => '/settings/credentials', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Test login emails and passwords', 'input' => new stdClass(), 'output' => array(array('role' => 'Promoter / Admin', 'email' => 'velrke@gmail.com', 'password' => 'Admin@123'))),
			array('group' => 'Settings', 'method' => 'POST', 'path' => '/settings/mail-test', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Send/queue a test email', 'input' => array('to' => 'velrke@gmail.com'), 'output' => array('queued_or_sent' => true)),
