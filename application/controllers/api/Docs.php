...
class Docs extends Api_Controller
{
	...
	public function catalog()
	{
		...
		$endpoints = array(
			...
			array('group' => 'Auth', 'method' => 'POST', 'path' => '/auth/forgot', 'auth' => false, 'summary' => 'Request password reset token via mail', 'input' => array('email' => 'admin@syncr.test'), 'output' => array('success' => true)),
			array('group' => 'Auth', 'method' => 'POST', 'path' => '/auth/reset', 'auth' => false, 'summary' => 'Reset password with token', 'input' => array('token' => 'abc', 'password' => 'NewPass@123'), 'output' => array('success' => true)),
			...
			array('group' => 'Inventory', 'method' => 'PUT', 'path' => '/inventory/{id}', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Update unit / status / price', 'input' => array('status' => 'blocked', 'price' => 3700000), 'output' => array('success' => true)),
			...
			array('group' => 'Requests', 'method' => 'POST', 'path' => '/requests/{id}/review', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Approve or reject. Approved sets unit to blocked.', 'input' => array('decision' => 'approved', 'review_notes' => 'Hold 7 days'), 'output' => array('status' => 'approved')),
			...
			array('group' => 'Bookings', 'method' => 'POST', 'path' => '/bookings', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Create booking and set unit booked', 'input' => array('unit_id' => 1, 'customer_name' => 'Ravi Kumar', 'amount' => 3600000, 'company_id' => 1), 'output' => array('id' => 3)),
			array('group' => 'Bookings', 'method' => 'PUT', 'path' => '/bookings/{id}', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Update booking customer, amount, status, payment', 'input' => array('status' => 'confirmed', 'payment_status' => 'paid'), 'output' => array('success' => true)),
			array('group' => 'Bookings', 'method' => 'DELETE', 'path' => '/bookings/{id}', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Soft-delete a booking and release the unit if still booked', 'input' => new stdClass(), 'output' => array('success' => true)),
			array('group' => 'Bookings', 'method' => 'GET', 'path' => '/bookings/export', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'CSV export of filtered bookings', 'input' => new stdClass(), 'output' => 'text/csv'),
			...
			array('group' => 'Reports', 'method' => 'GET', 'path' => '/reports', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Combined bookings/registrations report with quick stats', 'input' => array('type' => 'bookings', 'company_id' => 1), 'output' => array('quick_stats' => array())),
			...
			array('group' => 'Schema', 'method' => 'POST', 'path' => '/schema/add-column', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'ALTER TABLE ADD COLUMN (DROP/DELETE/TRUNCATE blocked)', 'input' => array('table' => 'projects', 'column' => 'rera_no', 'type' => 'VARCHAR', 'length' => '50', 'nullable' => true), 'output' => array('sql' => 'ALTER TABLE ...')),
			array('group' => 'Schema', 'method' => 'POST', 'path' => '/schema/query', 'auth' => true, 'roles' => array('promoter_admin'), 'summary' => 'Safe query builder. DELETE/DROP/TRUNCATE are rejected.', 'input' => array('sql' => 'SELECT id, name FROM projects LIMIT 5'), 'output' => array('rows' => array()))
		);
