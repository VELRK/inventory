...
('app_name','SYNCR','general',0,NOW()),
('app_tagline','Real Estate Inventory Management','general',0,NOW()),
('mail_protocol','smtp','mail',0,NOW()),
('mail_smtp_host','smtp.gmail.com','mail',0,NOW()),
('mail_smtp_port','587','mail',0,NOW()),
('mail_smtp_user','','mail',1,NOW()),
('mail_smtp_pass','','mail',1,NOW()),
('mail_smtp_crypto','tls','mail',0,NOW()),
('mail_from_email','noreply@syncr.test','mail',0,NOW()),
('mail_from_name','SYNCR Portal','mail',0,NOW()),
('mail_enabled','0','mail',0,NOW()),
